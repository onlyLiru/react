...
RNActivityIndicator=function(_React$Component){(0,_inherits3["default"])(RNActivityIndicator,_React$Component);function RNActivityIndicator(){(0,_classCallCheck3["default"])(this,RNActivityIndicator);return(0,_possibleConstructorReturn3["default"])(this,_React$Component.apply(this,arguments));}RNActivityIndicator.prototype.
_renderToast=function _renderToast(){
var styles=this.props.styles;
return _react2["default"].createElement(_reactNative.View,{style:[styles.container]},
_react2["default"].createElement(_reactNative.View,{style:[styles.innerContainer,{height:89}]},
...
this.props.text&&_react2["default"].createElement(_reactNative.Text,{style:[styles.toast]},this.props.text))));



};RNActivityIndicator.prototype.
_renderSpinner=function _renderSpinner(){
return _react2["default"].createElement(_reactNative.View,{style:this.props.styles.spinner},
_react2["default"].createElement(_reactNative.ActivityIndicator,{color:this.props.color,size:this.props.size}),
this.props.text&&_react2["default"].createElement(_reactNative.Text,{style:[this.props.styles.tip]},this.props.text));
...
return null;
};return RNActivityIndicator;}(_react2["default"].Component);exports["default"]=RNActivityIndicator;
