...
this.props,children=_props.children,disabled=_props.disabled,small=_props.small,closable=_props.closable,styles=_props.styles,style=_props.style;
...
var closableDom=closable&&!small&&!disabled?_react2["default"].createElement(_reactNative.TouchableWithoutFeedback,{onPressIn:this.onPressIn,onPressOut:this.onPressOut,onPress:this.onTagClose},
_react2["default"].createElement(_reactNative.View,{ref:function ref(component){return _this2.closeDom=component;},style:[styles.close,_reactNative.Platform.OS==='ios'?styles.closeIOS:styles.closeAndroid]},
_react2["default"].createElement(_reactNative.Text,{style:[styles.closeText,_reactNative.Platform.OS==='android'?styles.closeTransform:{}]},'\xD7'))):

null;
return!this.state.closed?_react2["default"].createElement(_reactNative.View,{style:[styles.tag,style]},
_react2["default"].createElement(_reactNative.TouchableWithoutFeedback,{onPress:this.onClick},
_react2["default"].createElement(_reactNative.View,{style:[styles.wrap,sizeWrapStyle,wrapStyle]},
_react2["default"].createElement(_reactNative.Text,{style:[styles.text,sizeTextStyle,textStyle]},children,' '))),
