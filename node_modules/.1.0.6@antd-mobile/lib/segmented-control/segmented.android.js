...
this.props,style=_props2.style,disabled=_props2.disabled,_props2$values=_props2.values,values=_props2$values===undefined?[]:_props2$values,tintColor=_props2.tintColor,styles=_props2.styles;
...
_react2["default"].createElement(_reactNative.View,{style:itemStyle},
_react2["default"].createElement(_reactNative.Text,{style:[styles.itemText,{color:idx===selectedIndex?'#fff':tintColor}]},
value)));
...
return _react2["default"].createElement(_reactNative.View,{style:[styles.segment,segmentedStyle,style]},
items);
