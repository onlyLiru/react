...
var _reactNativeCameraRollPicker=require('react-native-camera-roll-picker');var _reactNativeCameraRollPicker2=_interopRequireDefault(_reactNativeCameraRollPicker);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{"default":obj};}
...
ImageRoll=function(_React$Component){(0,_inherits3["default"])(ImageRoll,_React$Component);
function ImageRoll(){(0,_classCallCheck3["default"])(this,ImageRoll);var _this=(0,_possibleConstructorReturn3["default"])(this,
...
return _react2["default"].createElement(_reactNative.Modal,{animationType:'slide',visible:true,onRequestClose:function onRequestClose(){},transparent:false},
...
_react2["default"].createElement(_reactNative.View,{style:[styles.naviBar]},
_react2["default"].createElement(_reactNative.Text,{style:[styles.barTitle]},'Photos'),
_react2["default"].createElement(_reactNative.TouchableOpacity,{onPress:this.props.onCancel},
_react2["default"].createElement(_reactNative.Text,{style:styles.rightBtn},'Cancel'))),


_react2["default"].createElement(_reactNativeCameraRollPicker2["default"],{selected:[],callback:this.onSelected,maximum:1})));


};return ImageRoll;}(_react2["default"].Component);exports["default"]=ImageRoll;module.exports=exports['default'];