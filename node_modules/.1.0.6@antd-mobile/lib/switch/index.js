...
AntmSwitch=function(_React$Component){(0,_inherits3["default"])(AntmSwitch,_React$Component);function AntmSwitch(){(0,_classCallCheck3["default"])(this,AntmSwitch);return(0,_possibleConstructorReturn3["default"])(this,_React$Component.apply(this,arguments));}AntmSwitch.prototype.
onChange=function onChange(value){
if(this.props.onChange){
this.props.onChange(value);
}
};AntmSwitch.prototype.

render=function render(){var _this2=this;var _props=
this.props,style=_props.style,disabled=_props.disabled,checked=_props.checked;
return _react2["default"].createElement(_reactNative.Switch,{style:style,onValueChange:function onValueChange(value){_this2.onChange(value);},value:checked,disabled:disabled});
};return AntmSwitch;}(_react2["default"].Component);exports["default"]=AntmSwitch;
