...
Progress=function(_React$Component){(0,_inherits3["default"])(Progress,_React$Component);
function Progress(props){(0,_classCallCheck3["default"])(this,Progress);var _this=(0,_possibleConstructorReturn3["default"])(this,
...
_this.getWidth=function(){var percent=arguments.length>0&&arguments[0]!==undefined?arguments[0]:_this.props.percent;
...
percentage:new _reactNative.Animated.Value(0)};return _this;
...
this.props,position=_props.position,unfilled=_props.unfilled,style=_props.style,styles=_props.styles;
var percentStyle={
width:this.getWidth(),
height:0};
...
return _react2["default"].createElement(_reactNative.View,{onLayout:this.onLayout,style:outerStyle},
child);
