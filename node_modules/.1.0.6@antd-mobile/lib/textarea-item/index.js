...
_this.props,autoHeight=_this$props.autoHeight,rows=_this$props.rows,onChange=_this$props.onChange;
if(autoHeight){
...
this.props,value=_props.value,defaultValue=_props.defaultValue,rows=_props.rows,error=_props.error,clear=_props.clear,count=_props.count,autoHeight=_props.autoHeight,last=_props.last,onErrorClick=_props.onErrorClick,styles=_props.styles,style=_props.style;
