...
AgreeItem=function(_React$Component){(0,_inherits3["default"])(AgreeItem,_React$Component);
function AgreeItem(){(0,_classCallCheck3["default"])(this,AgreeItem);var _this=(0,_possibleConstructorReturn3["default"])(this,
...
this.props,style=_props.style,checkboxStyle=_props.checkboxStyle,children=_props.children,disabled=_props.disabled,checked=_props.checked,defaultChecked=_props.defaultChecked,onChange=_props.onChange,styles=_props.styles;
...
return _react2["default"].createElement(_reactNative.TouchableWithoutFeedback,{onPress:this.handleClick},
_react2["default"].createElement(_reactNative.View,{style:[styles.agreeItem,style]},
