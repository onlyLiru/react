...
var refRadio='radio';var
RadioItem=function(_React$Component){(0,_inherits3["default"])(RadioItem,_React$Component);
function RadioItem(){(0,_classCallCheck3["default"])(this,RadioItem);var _this=(0,_possibleConstructorReturn3["default"])(this,
...
this.props,style=_props.style,radioStyle=_props.radioStyle,defaultChecked=_props.defaultChecked,checked=_props.checked,disabled=_props.disabled,children=_props.children,onChange=_props.onChange,styles=_props.styles;
var contentDom=null;
...
contentDom=_react2["default"].createElement(_reactNative.Text,{style:contentStyle,numberOfLines:1},
this.props.children);
...
return _react2["default"].createElement(ListItem,{style:style,onClick:disabled?undefined:this.handleClick,extra:radioEl},
contentDom);
